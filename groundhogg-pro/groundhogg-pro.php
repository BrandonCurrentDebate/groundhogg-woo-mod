 ...
 * Description: Adds advanced funnel steps, advanced email editor, superlinks and more.
 * Version: 3.2.6.5
...
define( 'GROUNDHOGG_PRO_VERSION', '3.2.6.5' );
define( 'GROUNDHOGG_PRO_PREVIOUS_STABLE_VERSION', '3.2.6.4' );
...
define( 'GROUNDHOGG_PRO_REQUIRED_CORE_VERSION', '3.5' );
