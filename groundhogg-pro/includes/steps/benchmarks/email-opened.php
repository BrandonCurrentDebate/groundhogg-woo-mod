...
use function GroundhoggPro\get_email_steps_before_given_step;
...
class Email_Opened extends Benchmark {
	...
	public function get_description() {
		return __( 'Runs when a contact opens an email previously within the funnel.', 'groundhogg-pro' );
	}

	public function get_icon() {
		return GROUNDHOGG_PRO_ASSETS_URL . '/images/funnel-icons/email-opened.svg';
	}
	...
	public function settings( $step ) {
		...
		$email_steps = get_email_steps_before_given_step( $step->get_id() );
